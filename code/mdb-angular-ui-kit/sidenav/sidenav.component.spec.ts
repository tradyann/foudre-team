...
describe('MDB Groups Sidenav', () => {
  ...
  let firstCollapse: ElementRef;
  let secondCollapse: ElementRef;
  let thirdCollapse: ElementRef;
  let fourthCollapse: ElementRef;
  ...
  beforeEach(() => {
    ...
    firstCollapse = testComponent.firstCollapse;
    secondCollapse = testComponent.secondCollapse;
    thirdCollapse = testComponent.thirdCollapse;
    fourthCollapse = testComponent.fourthCollapse;
    collapseElements = document.querySelectorAll('.sidenav-collapse');
  });
  ...
  it('should close other category list only in clicked sidenav menu if accordion = true and mdbSidenavMenu directive is used', fakeAsync(() => {
    ...
    expect(collapseElements[0].classList.contains('show')).toBe(false);
    expect(collapseElements[1].classList.contains('show')).toBe(false);
    expect(collapseElements[2].classList.contains('show')).toBe(false);
    expect(collapseElements[3].classList.contains('show')).toBe(false);
    ...
    expect(collapseElements[0].classList.contains('show')).toBe(false);
    expect(collapseElements[1].classList.contains('show')).toBe(true);
    expect(collapseElements[2].classList.contains('show')).toBe(false);
    expect(collapseElements[3].classList.contains('show')).toBe(false);

    thirdCollapse.nativeElement.click();
    fixture.detectChanges();
    flush();

    expect(collapseElements[0].classList.contains('show')).toBe(false);
    expect(collapseElements[1].classList.contains('show')).toBe(true);
    expect(collapseElements[2].classList.contains('show')).toBe(true);
    expect(collapseElements[3].classList.contains('show')).toBe(false);

    fourthCollapse.nativeElement.click();
    fixture.detectChanges();
    flush();
    ...
    expect(collapseElements[1].classList.contains('show')).toBe(true);
    expect(collapseElements[2].classList.contains('show')).toBe(false);
    expect(collapseElements[3].classList.contains('show')).toBe(true);
...
@Component({
  ...
  template: `
    <mdb-sidenav-layout>
      <mdb-sidenav [accordion]="accordion" [hidden]="hidden" [position]="position">
        ...
        <ul class="sidenav-menu" mdbSidenavMenu>
          ...
          <mdb-sidenav-item>
            <a class="sidenav-link" #thirdCollapse
          ...
          <mdb-sidenav-item>
            <a class="sidenav-link" #fourthCollapse
              ><i class="fas fa-grin-wink fa-fw me-3"></i><span>Category 4</span></a
            >
            <ul class="sidenav-collapse" mdbCollapse>
              <li class="sidenav-item">
...
class GroupsSidenavComponent {
  @ViewChild('firstCollapse') firstCollapse: ElementRef;
  @ViewChild('secondCollapse') secondCollapse: ElementRef;
  @ViewChild('thirdCollapse') thirdCollapse: ElementRef;
  @ViewChild('fourthCollapse') fourthCollapse: ElementRef;
  @ViewChildren(MdbCollapseDirective) collapseElements: QueryList<MdbCollapseDirective>;
