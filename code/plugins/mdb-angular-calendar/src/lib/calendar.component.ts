...
export type MdbCalendarView = 'month' | 'list' | 'week';
@Component({
...
export class MdbCalendarComponent implements OnInit {
  ...
  @Input() blur = false;
  @Input()
  get defaultView(): MdbCalendarView {
    return this._defaultView;
  }
  set defaultView(view: MdbCalendarView) {
    this._defaultView = view;
  }
  private _defaultView: MdbCalendarView = 'month';
  ...
  @Output() viewChanged: EventEmitter<MdbCalendarView> = new EventEmitter();
  ...
  changeView(view: MdbCalendarView): void {
    if (this.view !== view) {
      this.view = view;
