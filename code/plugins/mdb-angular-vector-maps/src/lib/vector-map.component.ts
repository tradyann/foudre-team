...
export class MdbVectorMapComponent implements OnInit, OnDestroy {
  ...
  private _removeEvents() {
    if (this.svgElement) {
      ...
      this._document.removeEventListener('mousemove', this._mouseMoveHandler);
      this._document.removeEventListener('mouseup', this._mouseEndHandler);

      this.svgElement.nativeElement.removeEventListener('touchstart', this._touchStartHandler);
      this._document.removeEventListener('touchmove', this._touchMoveHandler);
      this._document.removeEventListener('touchend', this._touchEndHandler);
    }
